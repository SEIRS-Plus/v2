...
compartmentBuilder = CompartmentModelBuilder()
...
compartmentBuilder.add_transition(
    "S", to="E", upon_exposure_to=["P", "I", "A"], prob=1.0
)
compartmentBuilder.add_transition("E", to="P", time=latent_period, prob=1.0)
compartmentBuilder.add_transition(
    "P", to="I", time=presymptomatic_period, prob=1 - pct_asymptomatic
)
compartmentBuilder.add_transition(
    "P", to="A", time=presymptomatic_period, prob=pct_asymptomatic
)
